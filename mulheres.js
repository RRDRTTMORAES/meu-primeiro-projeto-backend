...
const router = express.Router()//aqui estou configurandoa primeira
...
async function corrigeMulher(request, response){
    try {
        ...
        const muherAtualizadaNoBancoDeDados = await mulherEncontrada.save()
        response.json(muherAtualizadaNoBancoDeDados)
